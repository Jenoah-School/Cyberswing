...
namespace GXPEngine
{
	...
	public class Sprite : GameObject
	{
		...
		//------------------------------------------------------------------------------------------------------------------------
		/// <summary>
		/// Checks if the object is still on screen or not
		/// </summary>
		/// <returns>Returns true when object is on screen. False when not on screen</returns>
		//public bool IsOnScreen()
		//{
		//	if (MyGame.Instance.GetCamera().x - x - (game.width / 2) > 0 || MyGame.Instance.GetCamera().x - x - (game.width / 2) < -game.width || MyGame.Instance.GetCamera().y - y - (game.height / 2) > 0 || MyGame.Instance.GetCamera().y - y - (game.height / 2) < -game.height)
		//	{
		//		return false;
		//	}
		//	return true;
